package com.clinic.logistica_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleIllegalState(IllegalStateException ex, HttpServletRequest req) {
        return buildResponse(HttpStatus.CONFLICT, "Stock insuficiente o conflicto logístico", ex.getMessage(), req.getRequestURI());
    }
