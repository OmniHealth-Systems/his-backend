package com.clinic.auditoria_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(EntityNotFoundException ex, HttpServletRequest req) {
        return buildResponse(HttpStatus.NOT_FOUND, "Registro de auditoría no encontrado", ex.getMessage(), req.getRequestURI());
    }
