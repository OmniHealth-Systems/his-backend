package com.clinic.farmacia_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(EntityNotFoundException ex, HttpServletRequest req) {
        return buildResponse(HttpStatus.NOT_FOUND, "Medicamento o venta no encontrada", ex.getMessage(), req.getRequestURI());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleStockInsuficiente(IllegalStateException ex, HttpServletRequest req) {
        return buildResponse(HttpStatus.CONFLICT, "Stock insuficiente", ex.getMessage(), req.getRequestURI());
    }
