package com.clinic.consultas_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleIllegalState(IllegalStateException ex, HttpServletRequest req) {
        return buildResponse(HttpStatus.CONFLICT, "Conflicto de negocio en consulta", ex.getMessage(), req.getRequestURI());
    }
